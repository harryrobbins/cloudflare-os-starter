...
//
//   node scripts/pack-gadget.mjs                      write dist/project-board.gadget (default; touches
//                                                     nothing outside this package)
//   node scripts/pack-gadget.mjs --formats <dir>      coordinator only: write <dir>/project-board.gadget
//                                                     and <dir>/project-board.json (from format.json),
//                                                     bumping `revision` via gadget.lock.json when code changed
//   node scripts/pack-gadget.mjs --check <dir>        exit 1 if <dir>/project-board.gadget is stale
//
