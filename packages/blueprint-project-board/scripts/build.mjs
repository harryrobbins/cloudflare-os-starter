...
export async function buildGadget(outDir = dist) {
  ...
  await build({
    ...
    banner: { js: `// ${NAME} gadget server. Built from packages/blueprint-project-board; edit there, not here.` },
  });
  await build({
    ...common,
    ...
    platform: "browser",
    banner: { js: `// ${NAME} gadget client. Built from packages/blueprint-project-board; edit there, not here.` },
  });
