...
export async function buildGadget(outDir = dist) {
  ...
  await build({
    ...
    banner: { js: "// Whiteboard gadget server. Built from packages/blueprint-whiteboard; edit there, not here." },
  });
  await build({
    ...common,
    ...
    platform: "browser",
    banner: { js: "// Whiteboard gadget client. Built from packages/blueprint-whiteboard; edit there, not here." },
  });
