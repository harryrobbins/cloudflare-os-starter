...
const sidecar = {
  title: "Whiteboard", description: "d", author: { type: "user", name: "n", id: "i" },
  output: { id: "whiteboard", noun: "Whiteboard", plural: "Whiteboards", icon: "flowArrow" }, revision: 3,
};
...
describe("gadget archives", () => {
  it("packs deterministically and round-trips", () => {
    ...
    expect(metadata).toMatchObject({ title: "Whiteboard", version: 3, bindings: {}, output: sidecar.output });
  });
