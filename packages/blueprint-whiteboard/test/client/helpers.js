...
/**
 * The objects of a store's optimistic board as a plain record, for comparison.
 * @param {import("../../src/client/store-contract.js").Store} store
 */
export function objectsOf(store) {
  return { ...store.getState().board.objects };
}
