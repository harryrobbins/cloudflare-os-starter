 ...
 * @property {"canvas"|"presentation"|"text"|"route"} [scope]  default "canvas"; "route": while editing a connector's route; "text": while typing in
 ...
 * @param {"canvas"|"presentation"|"text"|"route"} [scope]
