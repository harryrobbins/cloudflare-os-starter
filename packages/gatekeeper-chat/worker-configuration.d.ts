/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4183e73e165031e5a1ca5f38127710d8)
// Runtime types generated with workerd@1.20260815.1 2026-08-04 allow_irrevocable_stub_storage,nodejs_compat
// HAND EDIT, re-apply after `wrangler types`: the two `import(...)` paths below are rewritten from
// `./.wrangler/validate/src/index` (wrangler follows wrangler.jsonc's `main`, which is the
// capnweb-validate build output) to `./src/index`. Left as generated, an import from this .d.ts
// pulls the generated copy of src/ into the program: `tsc` then reports every error twice, and a
// stale copy reports errors that no longer exist. `exclude` cannot help -- it filters `include`,
// not imports.
interface __BaseEnv_Env {
	...
	CHAT_WORKSPACE: DurableObjectNamespace<import("./src/index").ChatWorkspace>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_ISS" | "CF_ACCESS_AUD" | "ADMINS" | "PUBLIC_BASE_URL" | "MAX_UPLOAD_BYTES">> {}
}
