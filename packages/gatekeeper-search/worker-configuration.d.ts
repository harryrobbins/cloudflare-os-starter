/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 64f6331f71086ff512b7f1d9441b2170)
// Runtime types generated with workerd@1.20260815.1 2026-08-04 allow_irrevocable_stub_storage,nodejs_compat
// HAND EDIT, re-apply after `wrangler types --strict-vars=false`: the `import(...)` paths below are
// rewritten from `./.wrangler/validate/src/index` (wrangler follows wrangler.jsonc's `main`, the
// capnweb-validate build output) to `./src/index`, as in packages/gatekeeper-chat. Left as
// generated, `tsc` pulls the build copy of src/ into the program and reports every error twice.
interface __BaseEnv_Env {
	...
	AI_GATEWAY: string;
	RERANK: string;
	SEARCH_INDEX: DurableObjectNamespace<import("./src/index").SearchIndex>;
	CONTEXT_FEED: DurableObjectNamespace<import("./src/index").ContextFeed>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SearchIndex" | "SearchGatekeeper" | "ContextFeed";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_ISS" | "CF_ACCESS_AUD" | "ADMINS" | "PUBLIC_BASE_URL" | "AI_GATEWAY" | "RERANK">> {}
}
