...
export const BLUEPRINT_BINDINGS = Object.freeze({
  [BINDING_NAME]: {
    title: "Projects datastore (read-only)",
    description:
      "An organisation Projects datastore (Records service, API v1). This report only reads: " +
      "connect it with projects.read and issues.read, nothing more.",
    type: "gatekeeper",
