...
// tab re-reads the datastore every 60 s (a report re-reads every issue, so it polls less often than the board). The Refresh button always does a full read.
//
