...
node packages/blueprint-notebook/e2e/setup.mjs
...
`setup.mjs` covers a fresh account using Connections → Connect resource → Notebook Python → Notebook Python kernel, direct account provisioning, the configurator handshake, and enabled Run/Stop controls. No RPC setup helpers bypass this flow.
