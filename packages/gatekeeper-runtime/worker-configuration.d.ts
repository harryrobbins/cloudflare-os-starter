/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.types.jsonc` (hash: bc9bb941ca70d925b8808073a8d58cae)
// Runtime types generated with workerd@1.20260815.1 2026-09-16 allow_irrevocable_stub_storage,nodejs_compat
interface __BaseEnv_Env {
	PYTHON: DurableObjectNamespace<import("./src/index").PythonSandbox>;
	SESSIONS: DurableObjectNamespace<import("./src/index").RuntimeSession>;
	ACCOUNTS: DurableObjectNamespace<import("./src/index").RuntimeAccountState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PythonSandbox" | "RuntimeSession" | "RuntimeAccountState" | "RuntimeGatekeeper";
	}
