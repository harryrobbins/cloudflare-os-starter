...
export async function buildGadget(outDir = dist) {
  ...
  await build({
    ...
    banner: { js: "// Kanban board gadget server. Built from packages/blueprint-kanban; edit there, not here." },
  });
  await build({
    ...common,
    ...
    platform: "browser",
    banner: { js: "// Kanban board gadget client. Built from packages/blueprint-kanban; edit there, not here." },
  });
