...
//
// Plain ESM; imports `playwright` (devDependency of blueprint-kanban, pinned to 1.61.0 so it uses
...
/**
 * Click an export format and capture the resulting file. Returns { filename, text } or throws.
