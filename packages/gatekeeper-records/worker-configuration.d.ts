/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c13505a133f09025be728e3c475fe650)
// Runtime types generated with workerd@1.20260815.1 2026-08-04 allow_irrevocable_stub_storage,nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	HYPERDRIVE_PUBLISHER: Hyperdrive;
	CHANGES: Queue;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "RecordsGatekeeper" | "RecordsConnectFlow" | "DatastoreFeed";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_ISS" | "CF_ACCESS_AUD" | "RECORDS_API_ACCESS_AUD" | "PUBLIC_BASE_URL">> {}
}
